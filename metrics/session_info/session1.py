...
openai_org_id = "org-8BwheRTrv47l6MxkOrVnU7uG" #os.getenv('OPENAI_ORG_ID')
openai_api_key = "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" #os.getenv('OPENAI_API_KEY')
