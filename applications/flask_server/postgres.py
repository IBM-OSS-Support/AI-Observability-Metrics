...
def process_accuracy(message,conn,json_object):
    ...
    cursor.execute(insert_metric_sql, (json.dumps(json_object["accuracy"]), json_object["application-name"], json_object["app-user"], json_object["application-id"], current_timestamp))
...
def process_user_satisfaction(message,conn,json_object):
    ...
    cursor.execute(insert_metric_sql, (json.dumps(json_object["rating"]), json_object["comment"],json_object["application-name"], json_object["app-user"], json_object["application-id"], current_timestamp))
...
def process_log_history(message,conn,json_object):
    ...
    cursor.execute(insert_metric_sql, (json.dumps(json_object), status, finish_reason, json_object["application-name"], json_object["app-user"], json_object["application-id"], current_timestamp))
...
def process_metrics(message,conn,json_object):
    ...
    cursor.execute(insert_metric_sql, (json.dumps(json_usage_objects), token_cost, json_object["application-name"], json_object["app-user"], json_object["application-id"], current_timestamp))
    ...
    cursor.execute(insert_metric_sql, (json.dumps(json_performance_objects), json_object["application-name"], json_object["app-user"], json_object["application-id"], current_timestamp))
        ...
        if "tags" in span:
            for tag in span["tags"]:
                if "key" in tag and tag["key"] == "operation":
                    ...
                    cursor.execute(insert_metric_sql, (json.dumps(span["span_id"]), op, json.dumps(span["exceptions"]), json.dumps(span["usage"]), json.dumps(span["config"]), json.dumps(span["tags"]), start_us, end_us, latency_ns, json_object["application-name"], json_object["app-user"], json_object["application-id"], current_timestamp))
...
def process_auditing_message(message,conn,json_object):
    ...
    cursor.execute(insert_metric_sql, (json.dumps(json_object["flagged"]), json.dumps(json_object["categories"]), json.dumps(json_object["category_scores"]), json_object["application-name"], json_object["app-user"], json_object["application-id"], current_timestamp))
