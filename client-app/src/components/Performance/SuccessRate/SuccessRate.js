  ...
  // start
    ...
    useEffect(() => {
      ...
      if(state.status === 'success') {
        ...
        newAvgValue = messageFromServerAbandonment[0].success_percentage; 
    ...
    if(messageFromServerAbandonment){
      console.log('Abandonment messageFromServer.gauge', messageFromServerAbandonment[0].success_percentage);
