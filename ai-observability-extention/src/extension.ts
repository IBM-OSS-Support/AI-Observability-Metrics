...
async function runInsertCodeTemplateCommand(context: vscode.ExtensionContext) {
    try {
        ...
        if (platform === 'win32') {
            ...
            terminal.show();
            terminal.sendText(
                'docker run --name ai-observability-metrics -itd --memory="2g" --restart unless-stopped -p 5432:5432 -p 15000:15000 -p 12000:12000 -p 3000:3000 ghcr.io/ibm-oss-support/ai_observability_metrics_windows:2.0'
            );
